...
function inferEffectiveRank(
  ...
  // Star: either 4+ legs with BV OR sufficient total BV (10,000+)
  // Backend allows: legsWithBV >= 4 OR totalBV >= 10000
...
export const Dashboard: React.FC = () => {
  ...
  const effectiveRank = inferEffectiveRank(rank, directCount, legsWithBV, legsWithStar, legsWithGold, totalBV);
